        ...
        <>
            <Dialog open={open} onOpenChange={onOpenChange}>
                ...
                >
                    ...
                    {/* Toolbar */}
                    <div className="flex items-center gap-3 px-2 py-3 border-b bg-muted/30 justify-between">
                        ...
                        <div className='flex gap-2 items-center'>
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    if (files.length > 0) {
                                        handleDrop({ preventDefault: () => { }, stopPropagation: () => { }, dataTransfer: { files } } as any)
                                    }
                                    e.target.value = ''
                                }}
                            />
